# BeyondLabel — User Stories
Version: 1.0
Status: To be expanded after user research
...
that I can analyze products I find in a physical store without 
typing anything

US3: As a user I want the verdict to explain WHY a claim is 
misleading in plain English so that I actually learn something 
and can make better decisions in the future

US4: As a user I want a clear Trustworthy / Question It / 
Avoid verdict so that I can make a fast decision without 
...
sugars regardless of what they are called — jaggery, 
maltodextrin, corn syrup — so that I can protect my health

US8: As a user trying to lose fat I want the analysis to 
expose serving size manipulation so that I understand the 
actual caloric impact of consuming a product normally
